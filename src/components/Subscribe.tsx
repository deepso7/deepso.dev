...
const Subscribe: React.FC = () => (
  <div className="relative py-24">
    <NextImage
      ...
      width={500}
      height={500}
      className="absolute top-1/2 left-1/2 z-[1] hidden w-full -translate-x-1/2 -translate-y-1/2 select-none md:block"
    />
    <NextImage
      ...
      width={100}
      height={100}
      className="absolute top-0 z-[1] w-full select-none md:hidden"
    />
